...
<%
    ...
    try {
        con = ConexionBD.obtenerConexion();
        ps = con.prepareStatement("SELECT nombre, descripcion, icono FROM categorias");
        rs = ps.executeQuery();
        int i = 0;
        while (rs.next()) {
...
%>
    <div class="col-md-3 col-6 fade-in <%= claseDelay %>">
        <div class="feature-card <%= claseAcento %>">
...
<!-- ===================== ULTIMOS CONTENIDOS ===================== -->
<h2 class="h4 mb-3 fade-in">Últimos contenidos</h2>
<div class="row g-3">
<%
    // ---- Consulta: traer los ultimos contenidos publicados ----
    try {
        con = ConexionBD.obtenerConexion();
        ps = con.prepareStatement(
